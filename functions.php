...
function add_theme()
{
    ...
    // scripts
    wp_enqueue_script('aos_js', OMNI_JS . '/aos.js', NULL, true);
    wp_enqueue_script('jquery_js', OMNI_JS . '/jquery.js', NULL, true);
    wp_enqueue_script('common_js', OMNI_JS . '/common.js', NULL, 1.13, array('jquery'), true);
