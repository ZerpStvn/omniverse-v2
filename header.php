...
<head>
    ...
    <link rel="icon" href="<?php echo get_template_directory_uri() . "/assets/img/bgwhirl.svg"; ?>" type="image/x-icon">
</head>
<header>
    <div class="header global-width global-padding">
        <h1 class="omni-logo"><a href=" <?php echo get_home_url() . "/home" ?>"><img
                    src="<?php echo OMNI_IMG . "/om-logo.png" ?>" alt="omniverse"></a></h1>
