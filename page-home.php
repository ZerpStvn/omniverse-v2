    ...
    <div class="navbar global-width">
        <section>
            <div class="header-menu">
                <h1><a href="<?php echo get_home_url() . "/home" ?>"><img src="<?php echo OMNI_IMG . "/om-logo.png" ?>"
                            alt="omniverse"></a></h1>
            ...
            <div class="features">
                <ul>
                    ...
                    <li>Black start-up capability - through local power supply, UPS, battery bank, small wind or solar
                        power
                        installation</li>
                    <li>Compensated parasitic load - the gross output is designed to compensate, supply and offset the
